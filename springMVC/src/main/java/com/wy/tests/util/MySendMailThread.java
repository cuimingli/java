...
public class MySendMailThread extends Thread{
	...
	public void run() {
		...
		//发送邮件的协议名称 http://blog.csdn.net/qq_26525215/article/details/52276168
	    ...
	    Session session = Session.getDefaultInstance(p,new Authenticator(){
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				...
				return new PasswordAuthentication("1585159171@qq.com","84690cuili");
			}
	    });
	    ...
	    try {
            ...
            // 邮件信息封装
            // 1发件人
            msg.setFrom(new InternetAddress("1585159171@qq.com"));
            // 2收件人
            msg.setRecipient(RecipientType.TO, new InternetAddress("123799897@qq.com"));
            // 3邮件内容:主题、内容
            msg.setSubject("崔明利" + ",欢迎注册***账号,请点击链接激活账号");

            // StringBuilder是线程不安全的,但是速度快，这里因为只会有这个线程来访问，所以可以用这个
            StringBuilder sbd = new StringBuilder();
            sbd.append("崔明利" + "<br/>欢迎！请确认此邮件地址以激活您的账号。<br/>");
            sbd.append("<font color='red'><a href='http://192.168.1.102:8080/myMailWeb/ActiveServlet?acode="
                    + "123456" + "' target='_blank'");
            ...
            System.out.println("给" + "123799897@qq.com" + "发送邮件成功。");
